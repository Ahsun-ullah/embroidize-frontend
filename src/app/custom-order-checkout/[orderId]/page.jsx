...
function CustomOrderCheckoutInner() {
  ...
  const showMobilePayBar =
    order.status === 'awaiting_payment' && checkoutResult !== 'success';
              ...
              aside={
                isDownloadable && (
                  <Button
                    ...
                    radius='full'
                    variant='bordered'
                    className='shrink-0 border-zinc-300 font-medium text-zinc-800'
                    isLoading={downloading}
                    startContent={downloading ? null : <Download size={15} />}
              ...
              <Section no={nextNo()} title='Your files'>
                <div className='border-y-2 border-black py-6'>
                  ...
                  <p className='mt-2 max-w-prose text-sm leading-relaxed text-zinc-600'>
                    The ZIP contains every machine format — download it as many
                    times as you like.
                  </p>
        ...
        <aside className='lg:sticky lg:top-8 lg:w-[300px] lg:shrink-0'>
          ...
          <div className='rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm sm:p-6'>
            ...
            {order.estimatedPrice > 0 && (
              <div className='mt-3 flex items-baseline justify-between border-t-2 border-black pt-3'>
            ...
            {canDownloadReceipt && (
              <div className='mt-6 border-t border-zinc-200 pt-4'>
                <Button
                  ...
                  radius='full'
                  variant='bordered'
                  className='w-full border-zinc-300 font-medium text-zinc-800'
            ...
            <div className='mt-6 border-t border-zinc-200 pt-4'>
              <p className='text-xs leading-relaxed text-zinc-500'>
                <span className='font-semibold text-zinc-900'>Need help? </span>
                Email{' '}
                <a
                  href='mailto:support@embroidize.com'
